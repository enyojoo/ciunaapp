  ...
  async create(
    ...
    try {
      ...
      try {
        ...
        void import("./email-notification-service").then(({ EmailNotificationService }) =>
          EmailNotificationService.sendTransactionStatusEmail(data.transaction_id, "pending"),
        ).catch((error) => {
      ...
      try {
        ...
        void import("./email-notification-service").then(({ EmailNotificationService }) =>
          EmailNotificationService.sendAdminTransactionNotification(data.transaction_id, "pending"),
        ).catch((error) => {
