...
export const GET = withErrorHandling(async (request: NextRequest, context?: { params?: Promise<{ vendorSlug: string }> }) => {
  ...
  const res = NextResponse.json({
    vendor: {
      ...
      pickup_location: vendor.pickup_location != null ? String(vendor.pickup_location) : null,
      pickup_hours: vendor.pickup_hours != null ? String(vendor.pickup_hours) : null,
      fulfillment_notes: vendor.fulfillment_notes != null ? String(vendor.fulfillment_notes) : null,
