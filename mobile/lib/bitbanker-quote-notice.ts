...
/** User-facing quote preview notice — never raw fetch / stack messages. */
export type SendQuotePreviewNotice = {
  kind: "info" | "warning"
  /** i18n key under app namespace */
  messageKey: string
...
/**
 * Turn API / preview failures into copy the amount step can show inline.
 */
